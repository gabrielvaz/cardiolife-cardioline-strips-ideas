              ...
              {tableData.map((row, idx) => {
                  ...
                  return (
                    <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <div style={{ width: '40px', fontSize: '11px', color: '#6b7280' }}>{row.fullTime}</div>
                        <div style={{ flex: 1, height: '24px', backgroundColor: '#f3f4f6', borderRadius: '4px', overflow: 'hidden', position: 'relative' }}>
                             <div style={{ 
                                 width: '100%', height: '100%', 
                                 backgroundColor: color,
                                 opacity: 0.8
                             }} />
                             <span style={{ position: 'absolute', right: 8, top: 2, fontSize: '10px', fontWeight: 700, color: '#fff', textShadow: '0 1px 2px rgba(0,0,0,0.3)' }}>{row.mean} bpm</span>
                        </div>
                    </div>
                  )
              })}
